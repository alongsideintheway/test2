...
<form class="form-inline definewidth m20" action="#" method="get">
    <font color="#777777"><strong>大纲列表：</strong></font>
                ...
                $(obj.obj).each(function (index,item) {
                    ...
                    if(item.che==0){
                        ...
                        var str="<tr>\n" +
                            ...
                            "           <td>"+item.col+"</td>\n"+
                            "           <td>"+item.alltime+"</td>\n"+
                            "           <td><button type=\"button\"  onclick='check(" + item.id + ")'>" + che + "</td>\n" +
                            "       </tr>";
                        $("#tbody").append(str);
                    }
                    if(item.che==1){
                        ...
                        var str="<tr>\n" +
                            ...
                            "           <td>"+item.col+"</td>\n"+
                            "           <td>"+item.alltime+"</td>\n"+
                            "           <td><button type=\"button\"  disabled onclick='check(" + item.id + ")'>" + che + "</td>\n" +
                            "       </tr>";
                        $("#tbody").append(str);
                    }
...
<script>
    $("#searchBtn").click(function () {
        ...
        //
        $.ajax({
            url: "/outline/findoutlineLikeUname",
            type: "post",
            dataType: "json",
            data: {
                "tname": tname
