...
<div class="left">
    <div class="div1">
        <div class="left_top">
            <img jpsrc="images/bbb_01.g"><img src="images/bbb_02.jpg" id="2"><img src="images/bbb_03.jpg"><img
        ...
        <div class="div3">
            ...
            <ul>
                <li><a class="a" href="javascript:void(0);"
                       onClick="openurl('user_add.jsp');">添加用户</a></li>
            </ul>
